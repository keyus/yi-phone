...
const text = '第1数暗示意义为：(太极之数)太极之数，万物开泰，生发无穷，利禄亨通。 (吉)\n' +
    ...
    '第21数暗示意义为：(明月中天)光风霁月，万物确立，官运亨通，大搏名利。 (吉)\n' +
    '第22数暗示意义为：(秋草逢霜)秋草逢霜，困难疾弱，虽出豪杰，人生波折。 (凶)\n' +
    '第23数暗示意义为：(壮丽)旭日东升，壮丽壮观，权威旺盛，功名荣达。 (吉)\n' +
    ...
    '第28数暗示意义为：(阔水浮萍)遭难之数，豪杰气概，四海漂泊，终世浮躁。 (凶)\n' +
    ...
    '第33数暗示意义为：(旭日升天)旭日升天，鸾凤相会，名闻天下，隆昌至极。 (吉)\n' +
...
arr.forEach(it=>{
    ...
    const index = match1[0];
    const temp = {};
    temp.value = SHU_TYPE[match2[0]];
    temp.type = match2[0];
    temp.mean = it;
